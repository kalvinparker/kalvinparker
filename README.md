...
- 2025-11-05 — kalvinparker/getting-started-todo-app — 731049e — refactor: update Dockerfile and package.json for consistency; add zap.yaml for security scanning
...
- 2025-11-05 — kalvinparker/secure-gemini — 5c63868 — chore: update package-lock and add detect-secrets baseline
- 2024-09-21 — kalvinparker/KSyP.tech — 8c51a43 — Update fundamental-secuurity-concepts.md
- 2025-11-05 — kalvinparker/kalvinparker — ac625e2 — docs: aggregate recent changes across workspace
